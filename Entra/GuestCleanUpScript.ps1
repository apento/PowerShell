...
#$signins = Invoke-AzureRmOperationalInsightsQuery -WorkspaceId 7af40e4c-0969-4f2f-xxxx-5423a6b90026 -Query "SigninLogs | where TimeGenerated > datetime(2015-01-01) | where UserPrincipalName !contains 'Companys.com' | summarize max(CreatedDateTime) by UserId"
$signins = Invoke-AzureRmOperationalInsightsQuery -WorkspaceId 7af40e4c-0969-4f2f-xxxx-5423a6b90026 -Query "SigninLogs | where TimeGenerated > datetime(2015-01-01) | where UserPrincipalName !contains 'Companys.com' | summarize max(CreatedDateTime) by UserId"
#>
